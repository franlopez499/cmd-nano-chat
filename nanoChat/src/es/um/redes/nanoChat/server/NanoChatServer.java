...
public class NanoChatServer implements Runnable {
	...
	private static final int MYPROTOCOL = 97484746;
    ...
    private NanoChatServer(InetSocketAddress a)
    {
    	...
    	NCRoomManager roomA = new NCSimpleRoom("RoomA");
    	manager.registerRoomManager(roomA);
    	NCRoomManager roomB = new NCSimpleRoom("RoomB");
    	manager.registerRoomManager(roomB);
    	//rm.registerUser("Pepe", a);
    ...
    public void init()
    {
        ...
        //Si  ha ido bien entonces iniciamos el servidor en segundo plano
