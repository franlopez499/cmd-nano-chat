...
public abstract class NCRoomManager {
	...
	public abstract void broadcastMessage(String u, String message) throws IOException; // en vez de message NCmessage mejor para enviar notificaciones y demas por la sala.
